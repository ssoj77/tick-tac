      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <?php 
                  if (isset($_GET['err'])) {
                    echo '<div class="modal-header text-center"><span style="background-color: rgba(200,20,20,0.3); color: red; border-radius: 5px; padding: 5px;"> Mauvais login ou mot de passe</span></div>';
                  }
                ?>
